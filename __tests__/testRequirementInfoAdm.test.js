...
describe('Tela de informações do requerimento para o administrador', () => {
    let mock;
    ...
    it('Seta deve voltar para a tela de requerimentos', async () => {
        const { getByTestId } = render(
            <NavigationContainer>
              <RequirementInfoAdm navigation={mockNavigation} />
            </NavigationContainer>
        );
    ...
    it('Excluir Requerimento deve levar para a tela de requerimentos', async () => {
        const { getByText } = render(
            <NavigationContainer>
              <RequirementInfoAdm navigation={mockNavigation} />
            </NavigationContainer>
        ...
        fireEvent.press(getByText('Excluir Requerimento'));
